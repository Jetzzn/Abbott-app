...
const kUserKey =
  "os_v2_org_xuirxf6zfzeczjvhddk6cso5ickkxdgksh3u7feqahcgafyqqel5bw3rv2lbpw7zwpnsti33yjguevntzudhwpnshyqkfyr5nkhpo5y";
const kAPIKey =
  "os_v2_app_drvhqiteevfv5mdjb5sreqckm7a533nmfu3ukl5bsup2lnpmii55zbnetmdxayzh4fd4o2u6wl3ymk6rmki2bzdi47myznxxdwlc7mi";
...
exports.addUser = functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    const createdUser = await client.createUser(
      "1c6a7822-6425-4b5e-b069-0f6512404a67",
      user,
    );
...
exports.deleteUser = functions.https.onCall(async (data, context) => {
  ...
  const url = `https://api.onesignal.com/apps/1c6a7822-6425-4b5e-b069-0f6512404a67/users/by/external_id/${data.user_id}`;
